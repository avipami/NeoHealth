...
struct DataTitle: View {
    var body: some View {
            ...
            Text("CURRENT BURNED CALS")
            //.multilineTextAlignment(.leading)
            .font(Font.custom("KlavikaRegular-TF",size: 18.0))
...
struct ContentView: View {
    ...
    var activity = Activity.allActivities()
        ...
        VStack {
            ...
            ZStack (alignment: .bottom){
                ...
                ZStack {
                    ...
                    ZStack {
                        ...
                        VStack {
                            ...
                            Text("Steps Today").padding().offset(y:0).font(Font.custom("KlavikaRegular-TF",size: 30.0))
                            Text("\(Int())")
                                .padding()
                                .offset(y:0)
                                .font(Font.custom("KlavikaRegular-TF",size: 30.0))
                ...
                HStack(alignment: .center, spacing: 120){
                    Button(action: {
                        print("ButtonTapped")
                        //repository?.getTodaysTotalStepCount()
                    }){
                        Image("Fire-Magenta")
                            .resizable()
            ...
            .onAppear {
                if let repository = repository {
                    repository.requestAuthorization { success in
                        if success{
                           // healthStore.getTodaysTotalStepCount()
                            //stepsToday = healthStore.todaysSteps
